...
%  Here I compute the cosine by making a pair of delta functions
...
Ihat(KX+1,KY+1) = 1/2*N*N;

%  Make sure the conjugacy property is satisfied....

if KX > 0 && KY > 0
  Ihat(N+1-KX,N+1-KY) = 1/2*N*N;
elseif KX == 0  && KY ~= 0 
  Ihat(1,N+1-KY) = 1/2*N*N;
elseif KX ~= 0  && KY == 0 
  Ihat(N+1-KX,1) = 1/2*N*N;
end
